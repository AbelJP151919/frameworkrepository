      ...
      <div className="hero-section bg-primary text-white rounded p-5 mb-4">
        <div className="row align-items-center">
          <div className="col-md-8">
            ...
            <p className="lead">Tu portal personal de películas desarrollado con React</p>
        ...
        <div className="col-md-4 mb-3">
          <div className="card h-100">
            <div className="card-body text-center">
              ...
              <h5 className="card-title">Proyecto React</h5>
              <p className="card-text">Desarrollado como conversión del proyecto Flask en DAW2.</p>
            </div>
          </div>
        </div>
      </div>
